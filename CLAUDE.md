...
2. `docs/P1_INTEGRATION_SPEC.md` — **fuente de verdad del contrato REST** (junto al Swagger vivo de P2). El delta del 29-30/08 (renombres incompatibles, mapa, paginación) está en `docs/CAMBIOS_P2_PARA_P1_2026-08-30.md` — ya aplicado en P1 el 30/08. El delta del 31/08-01/09 (dúplex como filtro `is_duplex` + sello en la Card, `place` para barrios fuera del catálogo) está en `docs/CAMBIOS_P2_PARA_P1_2026-09-01.md` — aplicado en P1 el 01/09.
